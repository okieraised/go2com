...
func (n *Nii2) quaternToMatrix() matrix.DMat44 {
	var R matrix.DMat44

	var b = float64(n.Header.QuaternB)
	var c = float64(n.Header.QuaternC)
	var d = float64(n.Header.QuaternD)
	...
	R.M[0][3] = float64(n.Header.QoffsetX)
	R.M[1][3] = float64(n.Header.QoffsetY)
	R.M[2][3] = float64(n.Header.QoffsetZ)

	return R
}

func (n *Nii2) matrixToQuatern(R matrix.DMat44) {
	var r11, r12, r13, r21, r22, r23, r31, r32, r33 float64
	var xd, yd, zd, a, b, c, d float64

	var P, Q matrix.DMat33

	n.Data.QOffsetX = float64(R.M[0][3])
	n.Data.QOffsetY = float64(R.M[1][3])
	n.Data.QOffsetZ = float64(R.M[2][3])
	...
	n.Data.QuaternB = float64(b)
	n.Data.QuaternC = float64(c)
	n.Data.QuaternD = float64(d)
}

func (n *Nii2) matrixToOrientation(R matrix.DMat44) {
